...
export class Weather {
    constructor() {
        ...
        this.barometricPressureSummaries = [
    ...
    calculateLapseRate(a, b) {
        ...
        const tempDiff = lower.uk_hybrid.temp - upper.uk_hybrid.temp;
